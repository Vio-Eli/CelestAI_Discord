...
from celestai import api_library
from celestai.modules import active as active_mods

# Wake-up Word(s) must be in the sphinx dict file (or else RuntimeError occurs)
# Change to 'hey celeste' if background noise triggering occurs
# note that celeste apparenty has the same pronounciation as celest (in the word dict)
WAKE_UP_WORD = "celeste"
WAKE_UP_EXTENSION = "~"
...
API_DIRS = [
    # Add custom api directory strings here (e.g. - "C:/my_custom_api_dir")
]
API_DIRS.extend(api_library.__path__)
MOD_DIRS = [
    # Ad custom api directory strings here (e.g. - "C:/my_custom_mod_dir")
    'C:/Users/Starlight/AppData/Local/Programs/Python/Python36-32/Lib/site-packages/celestai/modules/active'
]
...
# For custom pronounciations, edit 'celestai.dict' and use this line instead
# POCKET_DICT =      join(DATA_DIR, 'celestai.dict')
